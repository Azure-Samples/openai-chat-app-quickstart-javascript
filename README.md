# Chat Application using Azure OpenAI (TypeScript)
...
[![Open in Dev Containers](https://img.shields.io/static/v1?style=for-the-badge&label=Dev%20Containers&message=Open&color=blue&logo=visualstudiocode)](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/azure-samples/openai-chat-app-quickstart-javascript)

This repository includes a TypeScript app that uses Azure OpenAI to generate responses to user messages.
...
* A [Fastify](https://fastify.dev/) app that uses the [openai](https://www.npmjs.com/package/openai) package to generate responses to user messages.
...
1. Make sure the following tools are installed:
    ...
    * [TypeScript 5+](https://www.TypeScript.org/downloads/)
...
Assuming you've run the steps to [open the project](#getting-started) and the steps in [Deploying](#deploying), you can now run the Fastify app in your development environment:
...
This will start the app on port 3000, and you can access it at `http://localhost:3000`.
